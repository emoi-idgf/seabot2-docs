...
.. code-block:: cpp
   ...
   void ICM20948Node::init_parameters() {
       ...
       this->declare_parameter<std::vector<double>>("magnetometerMisalignment", FusionMatrixToStdVector(magnetometerMisalignment_));
       magnetometerMisalignment_ = FusionMatrixFromStdVector(this->get_parameter_or("magnetometerMisalignment", FusionMatrixToStdVector(magnetometerMisalignment_)));
   
       this->declare_parameter<std::vector<double>>("magnetometerSensitivity", FusionVectorToStdVector(magnetometerSensitivity_));
       magnetometerSensitivity_ = FusionVectorFromStdVector(this->get_parameter_or("magnetometerSensitivity", FusionVectorToStdVector(magnetometerSensitivity_)));
   
       this->declare_parameter<std::vector<double>>("magnetometerOffset", FusionVectorToStdVector(magnetometerOffset_));
       magnetometerOffset_ = FusionVectorFromStdVector(this->get_parameter_or("magnetometerOffset", FusionVectorToStdVector(magnetometerOffset_)));
   ...
   void ICM20948Node::compute_ahrs() {
       ...
       magnetometer = FusionCalibrationInertial(magnetometer, magnetometerMisalignment_, magnetometerSensitivity_, magnetometerOffset_);
