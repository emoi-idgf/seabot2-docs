...
.. code-block:: cpp
   ...
   void SafetyNode::init_parameters() {
       ...
       this->declare_parameter<int>("depth_no_data_warning", static_cast<int>(depth_no_data_warning_.count()));
       this->declare_parameter<int>("battery_no_data_warning", static_cast<int>(battery_no_data_warning_.count()));
       this->declare_parameter<int>("internal_no_data_warning", static_cast<int>(internal_no_data_warning_.count()));
       this->declare_parameter<int>("piston_no_data_warning", static_cast<int>(piston_no_data_warning_.count()));
       this->declare_parameter<int>("ping_no_data_warning", static_cast<int>(ping_no_data_warning_.count()));
       ...
       this->declare_parameter<int>("piston_error_velocity_delay", static_cast<int>(piston_error_velocity_delay_.count()));
       this->declare_parameter<int>("seabed_delay_detection", static_cast<int>(seabed_delay_detection_.count()));
       ...
       safety_distance_from_seabed_ = this->get_parameter_or("safety_distance_from_seabed", safety_distance_from_seabed_);
       ...
       ping_confidence_threshold_ = this->get_parameter_or("ping_confidence_threshold", ping_confidence_threshold_);
       ...
       piston_error_velocity_delay_ = std::chrono::milliseconds(
           this->get_parameter_or("piston_error_velocity_delay", piston_error_velocity_delay_.count()));
   ...
   bool SafetyNode::test_internal_data() {
       ...
       if (internal_humidity_ > internal_humidity_limit_ || internal_pressure_ > internal_pressure_limit_) {
           ...
           if (this->now() - internal_last_rclcpp_warning_ > delay_between_warning_msg_) {
               ...
               RCLCPP_WARN(this->get_logger(), "[Safety_node] Depressurization detected %f%%, %f mbar", internal_humidity_,
                           internal_pressure_);
           }
       }
               ...
               if (ping_confidence_ > ping_confidence_threshold_) {
                   depth_limit_live_ = max(depth_allowed_min_,
                                           ...
                                           (1.0 - limit_depth_filter_coeff_) * min(
                                               depth_allowed_max_, bathy_ - safety_distance_from_seabed_));
