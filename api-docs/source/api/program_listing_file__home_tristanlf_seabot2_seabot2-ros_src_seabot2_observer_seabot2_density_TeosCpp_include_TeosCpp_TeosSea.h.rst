...
.. _program_listing_file__home_tristanlf_seabot2_seabot2-ros_src_seabot2_observer_seabot2_density_TeosCpp_include_TeosCpp_TeosSea.h:

Program Listing for File TeosSea.h
==================================

|exhale_lsh| :ref:`Return to documentation for file <file__home_tristanlf_seabot2_seabot2-ros_src_seabot2_observer_seabot2_density_TeosCpp_include_TeosCpp_TeosSea.h>` (``/home/tristanlf/seabot2/seabot2-ros/src/seabot2_observer/seabot2_density/TeosCpp/include/TeosCpp/TeosSea.h``)
...
.. code-block:: cpp
   ...
   ***************************/
   ...
   public:
     ...
     void gsw_ct_from_rho_exact(
       double rho, double SA, double p, double & CT,
       double & CT_multiple);
   
     void   gsw_ct_first_derivatives(
       double sa, double pt,
       double *ct_sa, double *ct_pt);
   
     void   gsw_ct_second_derivatives(
       double sa, double pt, double *ct_sa_sa,
       double *ct_sa_pt, double *ct_pt_pt);
   
     void gsw_enthalpy_first_derivatives_wrt_t_exact(
       double SA, double t, double p,
       double & h_SA_wrt_t,
       double & h_T_wrt_t,
       double & h_P_wrt_t);
   
     void   gsw_enthalpy_second_derivatives(
     ...
     double * gsw_geo_strf_dyn_height(
       double *sa, double *ct, double *p,
       double p_ref, int n_levels, double *dyn_height);
   
     int    gsw_geo_strf_dyn_height_1(
       double *sa, double *ct, double *p,
       double p_ref, int n_levels, double *dyn_height,
       double max_dp_i, int interp_method);
   
     void gsw_internal_energy_first_derivatives(
       double SA, double CT, double p,
       double & u_SA, double & u_CT,
       double & u_P);
   
     void gsw_internal_energy_first_derivatives_ct_exact(
       double SA, double CT,
     ...
     double gsw_isopycnal_slope_ratio(
       double SA, double CT, double p,
       double p_ref = 0.0);
     ...
     void   gsw_turner_rsubrho(
       double *sa, double *ct, double *p,
       int nz, double *tu, double *rsubrho, double *p_mid);
   
     double * gsw_util_interp1q_int(
       int nx, double *x, int *iy,
       int nxi, double *x_i, double *y_i);
   
     double * gsw_util_linear_interp(
       int nx, double *x, int ny,
       double *y, int nxi, double *x_i, double *y_i);
   
     int    gsw_util_pchip_interp(
