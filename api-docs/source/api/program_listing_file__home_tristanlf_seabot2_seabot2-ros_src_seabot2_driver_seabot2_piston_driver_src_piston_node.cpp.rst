...
.. code-block:: cpp
   ...
   void PistonNode::timer_callback()
   {
     ...
     if((this->now() - time_last_cmd_received_) > delay_no_data_ &&
       piston_.state_ != Piston::PISTON_EXIT)
     {
   ...
   void PistonNode::init_interfaces()
   {
     ...
     subscription_position_set_point_ = this->create_subscription<seabot2_msgs::msg::PistonSetPoint>(
               "piston_set_point", 10,
       std::bind(&PistonNode::topic_position_set_point_callback, this, _1));
   }
