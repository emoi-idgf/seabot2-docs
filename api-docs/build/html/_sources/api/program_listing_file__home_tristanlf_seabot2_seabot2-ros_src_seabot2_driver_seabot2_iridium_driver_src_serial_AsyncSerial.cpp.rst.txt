...
.. _program_listing_file__home_tristanlf_seabot2_seabot2-ros_src_seabot2_driver_seabot2_iridium_driver_src_serial_AsyncSerial.cpp:

Program Listing for File AsyncSerial.cpp
========================================

|exhale_lsh| :ref:`Return to documentation for file <file__home_tristanlf_seabot2_seabot2-ros_src_seabot2_driver_seabot2_iridium_driver_src_serial_AsyncSerial.cpp>` (``/home/tristanlf/seabot2/seabot2-ros/src/seabot2_driver/seabot2_iridium_driver/src/serial/AsyncSerial.cpp``)
...
.. code-block:: cpp
   ...
   #include "seabot2_iridium_driver/serial/AsyncSerial.h"
   ...
   public:
     AsyncSerialImpl()
     : io(), port(io), backgroundThread(), open(false),
       error(false) {}
     ...
     size_t bytes_transferred)
   {
     if(error) {
       ...
       if(pimpl->callback) {
         pimpl->callback(pimpl->readBuffer,
                   bytes_transferred);
       }
       doRead();
     }
