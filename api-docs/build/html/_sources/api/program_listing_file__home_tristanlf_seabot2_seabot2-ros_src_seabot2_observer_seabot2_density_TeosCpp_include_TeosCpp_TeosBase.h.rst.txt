...
.. _program_listing_file__home_tristanlf_seabot2_seabot2-ros_src_seabot2_observer_seabot2_density_TeosCpp_include_TeosCpp_TeosBase.h:

Program Listing for File TeosBase.h
===================================

|exhale_lsh| :ref:`Return to documentation for file <file__home_tristanlf_seabot2_seabot2-ros_src_seabot2_observer_seabot2_density_TeosCpp_include_TeosCpp_TeosBase.h>` (``/home/tristanlf/seabot2/seabot2-ros/src/seabot2_observer/seabot2_density/TeosCpp/include/TeosCpp/TeosBase.h``)
...
.. code-block:: cpp
   ...
   *********************************/
   ...
   public:
     ...
     void gsw_add_barrier(
       double *input_data, double lon, double lat, double long_grid,
     ...
     void gsw_ct_first_derivatives_wrt_t_exact(
     ...
     void gsw_enthalpy_first_derivatives(
       double sa, double ct, double p,
       double *h_sa, double *h_ct);
   
     void gsw_enthalpy_first_derivatives_ct_exact(
       double sa, double ct,
       double p, double *h_sa, double *h_ct);
   
     void gsw_enthalpy_second_derivatives_ct_exact(
       double sa, double ct, double p,
     ...
     void gsw_entropy_first_derivatives(
     ...
     void gsw_entropy_second_derivatives(
     ...
     void gsw_Hill_ratio_at_SP2(
       const double t_data[], const int t_size[2],
     ...
     void gsw_internal_energy_second_derivatives(
       double SA, double CT, double p,
     ...
     double gsw_p_from_z(
       double z, double lat, double geo_strf_dyn_height = 0.0,
     ...
     void gsw_pot_enthalpy_ice_freezing_first_derivatives_poly(
       double sa, double p,
     ...
     void gsw_rho_alpha_beta(
       double sa, double ct, double p, double *rho,
       double *alpha, double *beta);
   
     void gsw_rho_alpha_beta_indexed(
       double SA, double CT, double p, double & rho,
       double & alpha, double & beta);
   
     void gsw_rho_first_derivatives_CT_exact(
       double SA, double CT, double p,
       double & rho_SA, double & rho_CT,
       double & rho_P);
   
     void gsw_rho_first_derivatives_wrt_enthalpy_CT_exact(
       double SA, double CT,
       double p, double & rho_SA,
       double & rho_h);
   
     void gsw_rho_second_derivatives_CT_exact(
       double SA, double CT, double p,
       double *rho_SA_SA, double *rho_SA_CT, double *rho_CT_CT,
       double *rho_SA_P, double *rho_CT_P);
   
     void gsw_rho_second_derivatives_wrt_enthalpy_CT_exact(
       double SA, double CT,
       double p, double & rho_SA_SA, double & rho_SA_h, double & rho_h_h);
   
     void gsw_rr68_interp_section(
     ...
     double gsw_SA_freezing_from_CT_poly(
       double CT, double p,
     ...
     void gsw_weighted_nanmean(
       double data, double weights, double & weighted_mean,
       double & weighted_weights);
   
     double gsw_z_from_depth(double depth);
     double gsw_z_from_p(
       double p, double lat, double geo_strf_dyn_height = 0.0,
       double sea_surface_geopotential = 0.0);
