...
.. _program_listing_file__home_tristanlf_seabot2_seabot2-ros_src_seabot2_observer_seabot2_density_TeosCpp_src_TeosSea.cpp:

Program Listing for File TeosSea.cpp
====================================

|exhale_lsh| :ref:`Return to documentation for file <file__home_tristanlf_seabot2_seabot2-ros_src_seabot2_observer_seabot2_density_TeosCpp_src_TeosSea.cpp>` (``/home/tristanlf/seabot2/seabot2-ros/src/seabot2_observer/seabot2_density/TeosCpp/src/TeosSea.cpp``)
...
.. code-block:: cpp
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_ct_first_derivatives(
     double sa, double pt, double *ct_sa,
     double *ct_pt)
   {
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_enthalpy_second_derivatives(
     ...
     double *h_ct_ct)
   {
     ...
     if (h_sa_sa != NULL) {
       ...
       dynamic_h_sa_sa_part =
         ...
         xs2 * (3.0 * gsvco.h311 + xs * (8.0 * gsvco.h411 + 15.0 * gsvco.h511 * xs)) + ys *
         (-gsvco.h121 +
         xs2 * (3.0 * gsvco.h321 + 8.0 * gsvco.h421 * xs) + ys *
         (-gsvco.h131 + 3.0 * gsvco.h331 * xs2 +
         ys * (-gsvco.h141 - gsvco.h151 * ys)))) + z * (-gsvco.h102 + xs2 * (3.0 * gsvco.h302 +
         xs * (8.0 * gsvco.h402 + 15.0 * gsvco.h502 * xs)) + ys *
         (-gsvco.h112 + xs2 * (3.0 * gsvco.h312 +
         8.0 * gsvco.h412 * xs) + ys * (-gsvco.h122 + 3.0 * gsvco.h322 * xs2 +
         ys * (-gsvco.h132 - gsvco.h142 * ys ))) + z *
         (xs2 * (8.0 * gsvco.h403 * xs + 3.0 * gsvco.h313 * ys) +
         z *
         (-gsvco.h103 + 3.0 * gsvco.h303 * xs2 + ys *
         (-gsvco.h113 + ys * (-gsvco.h123 - gsvco.h133 * ys)) +
   ...
   ***************************************************************************/
   ...
   void TeosSea::gsw_rho_first_derivatives_wrt_enthalpy(
     double sa, double ct,
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_specvol_first_derivatives(
     double sa, double ct, double p,
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_specvol_first_derivatives_wrt_enthalpy(
     double sa, double ct,
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_specvol_second_derivatives(
     double sa, double ct, double p,
     ...
     double *v_ct_p)
   {
     ...
     if (v_sa_sa != NULL) {
       v_sa_sa_part = (-gsvco.b000 +
         ...
         ys * (-gsvco.b030 + gsvco.b230 * xs2 + ys * (-gsvco.b040 - gsvco.b050 * ys)))) + z *
         (-gsvco.b001 +
         ...
         ys * (-gsvco.b031 - gsvco.b041 * ys))) + z *
         (-gsvco.b002 + xs2 * (gsvco.b202 + 2.0 * gsvco.b302 * xs) +
     ...
     if (v_sa_ct != NULL) {
       v_sa_ct_part = (gsvco.b010 +
         ...
         gsvco.b140 * xs) + 5.0 * gsvco.b050 * ys))) + z *
         (gsvco.b011 + xs * (gsvco.b111 + xs * (gsvco.b211 +
     ...
     if (v_ct_ct != NULL) {
       v_ct_ct_part = gsvco.a010 +
         ...
         gsvco.a140 * xs) + 5.0 * gsvco.a050 * ys))) + z *
         (gsvco.a011 + xs * (gsvco.a111 + xs * (gsvco.a211 +
     ...
     if (v_sa_p != NULL) {
       v_sa_p_part = gsvco.b001 +
         ...
         ys * (gsvco.b031 + gsvco.b131 * xs + gsvco.b041 * ys))) + z *
         (2.0 * (gsvco.b002 + xs * (gsvco.b102 +
     ...
     if (v_ct_p != NULL) {
       v_ct_p_part = gsvco.a001 +
         ...
         xs * (gsvco.a202 + gsvco.a302 * xs)) + ys *
         (gsvco.a012 + xs * (gsvco.a112 + gsvco.a212 * xs) +
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_specvol_second_derivatives_wrt_enthalpy(
     double sa, double ct,
     double p,
     double *v_sa_sa,
     double *v_sa_h,
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_turner_rsubrho(
     double *sa, double *ct, double *p, int nz,
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_rho_alpha_beta_ct_exact(
     double SA, double CT, double p,
     double & rho_CT_exact,
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_internal_energy_second_derivatives(
     double SA, double CT,
     double p,
     double & u_SA_SA,
     double & u_SA_CT,
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_internal_energy_first_derivatives_ct_exact(
     double SA,
     double CT,
     double p,
     double & u_SA,
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_ct_from_rho_exact(
     double rho, double SA, double p,
     double & CT,
     double & CT_multiple)
   {
     double t, t_multiple;
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_ct_second_derivatives(
     double sa, double pt, double *ct_sa_sa,
   ...
   %==========================================================================
   ***************************************************************************/
   double * TeosSea::gsw_geo_strf_dyn_height(
     double *sa, double *ct, double *p,
   ...
   =======
   ******************************************************************/
   void TeosSea::gsw_p_sequence(
     double p1, double p2, double max_dp_i,
     double *pseq, int *nps)
   {
     double dp, pstep;
     int n, i;
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_pt_second_derivatives(
     double sa, double ct, double *pt_sa_sa,
   ...
   ======
   ****************************************************************************/
   int TeosSea::gsw_refine_grid_for_dh(
     double *p, double p_ref, int nz, double dp,
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_rho_first_derivatives(
     double sa, double ct, double p,
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_rho_second_derivatives_wrt_enthalpy(
     double sa, double ct,
     double p,
     double *rho_sa_sa,
     double *rho_sa_h,
   ...
   ==========================================================================
   *************************************************************************/
   double * TeosSea::gsw_util_interp1q_int(
     int nx, double *x, int *iy, int nxi,
   ...
   ==========================================================================
   *************************************************************************/
   double * TeosSea::gsw_util_linear_interp(
     int nx, double *x, int ny, double *y, int nxi, double *x_i,
     double *y_i)
   {
     char *in_rng = NULL;
   ...
   *************************************************************************/
   int TeosSea::gsw_util_pchip_interp(
     double *x, double *y, int n, double *xi,
     double *yi, int ni)
   {
     double *d = NULL;
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_specvol_alpha_beta(
     double sa, double ct, double p,
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_rho_second_derivatives(
     double sa, double ct, double p,
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_pt_first_derivatives(
     double sa, double ct, double *pt_sa,
     double *pt_ct)
   {
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_t_from_rho_exact(
     double rho, double SA, double p, double & t,
     double & t_multiple)
   {
     double sa, P, rho_40;
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_enthalpy_first_derivatives_wrt_t_exact(
     double SA, double t,
     double p,
     double & h_SA_wrt_t,
     double & h_T_wrt_t,
     double & h_P_wrt_t)
   {
     ...
     g08_SA = 8645.36753595126 + z * (-6620.98308089678 +
       z *
       (769.588305957198 + z * (-193.0648640214916 + (31.6816345533648 - 5.24960313181984 * z) * z))) +
       x * (-7296.43987145382 + x * (8103.20462414788 +
       y * (2175.341332000392 + y * (-274.2290036817964 +
       y * (197.4670779425016 + y * (-68.5590309679152 + 9.98788038278032 * y))) - 90.6734234051316 *
       z) +
       ...
       z *
       (598.378809221703 + z *
       (-156.8822727844005 + (204.1334828179377 - 10.23755797323846 * z) * z)) +
       y *
       (-1480.222530425046 + z * (-525.876123559641 + (249.57717834054571 - 88.449193048287 * z) * z) +
       y *
       (-129.1994027934126 + z *
       (1149.174198007428 + z * (-162.5751787551336 + 76.9195462169742 * z)) +
       y *
       ...
       z *
       (1388.489628266536 + z * (-409.779283929806 + (227.123395681188 - 22.2565468652826 * z) * z))) +
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_internal_energy_first_derivatives(
     double SA, double CT,
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosSea::gsw_rr68_interp_sa_ct(
     double *sa, double *ct, double *p, int mp,
