...
.. _program_listing_file__home_tristanlf_seabot2_seabot2-ros_src_seabot2_driver_pressure_ms5837_driver_src_pressure_ms5837_node.cpp:

Program Listing for File pressure_ms5837_node.cpp
=================================================

|exhale_lsh| :ref:`Return to documentation for file <file__home_tristanlf_seabot2_seabot2-ros_src_seabot2_driver_pressure_ms5837_driver_src_pressure_ms5837_node.cpp>` (``/home/tristanlf/seabot2/seabot2-ros/src/seabot2_driver/pressure_ms5837_driver/src/pressure_ms5837_node.cpp``)
...
.. code-block:: cpp
   ...
   class PressureMS5837Node final : public rclcpp::Node {
   public:
     PressureMS5837Node()
   ...
   void PressureMS5837Node::init_parameters()
   {
     ...
     pressure_sensor_.setI2CPeriph(this->get_parameter_or("i2c_periph",
       pressure_sensor_.getI2CPeriph()));
   ...
   {
     publisher_sensor_ =
       this->create_publisher<seabot2_msgs::msg::PressureSensorData>("pressure_external", 10);
   }
