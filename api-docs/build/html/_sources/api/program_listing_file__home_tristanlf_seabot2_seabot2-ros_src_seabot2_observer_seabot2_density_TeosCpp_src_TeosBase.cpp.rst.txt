...
.. _program_listing_file__home_tristanlf_seabot2_seabot2-ros_src_seabot2_observer_seabot2_density_TeosCpp_src_TeosBase.cpp:

Program Listing for File TeosBase.cpp
=====================================

|exhale_lsh| :ref:`Return to documentation for file <file__home_tristanlf_seabot2_seabot2-ros_src_seabot2_observer_seabot2_density_TeosCpp_src_TeosBase.cpp>` (``/home/tristanlf/seabot2/seabot2-ros/src/seabot2_observer/seabot2_density/TeosCpp/src/TeosBase.cpp``)
...
.. code-block:: cpp
   ...
   *******************************************/
   ...
   TeosBase::TeosBase()
   : t1(3.68017112855051e-2, 5.10878114959572e-2),t2(3.37315741065416e-1, 3.35449415919309e-1),
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_ct_first_derivatives_wrt_t_exact(
     double sa, double t, double p,
     double *ct_sa_wrt_t,
     double *ct_t_wrt_t,
     double *ct_p_wrt_t)
   {
   ...
   double TeosBase::gsw_deltasa_atlas(double p, double lon, double lat)
   {
       ...
       gsaar.lats_pan[gsaar.npan - 1] <= lat && lat <= gsaar.lats_pan[0])
     {
       ...
       gsw_add_barrier(dsar_old, lon, lat, pSaarData->get_longs_ref(indx0),
                                                            pSaarData->get_lats_ref(indy0), dlong,
         dlat, dsar);
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_enthalpy_first_derivatives(
     double sa, double ct, double p,
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_enthalpy_second_derivatives_ct_exact(
     double sa, double ct, double p,
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_entropy_first_derivatives(
     double sa, double ct, double *eta_sa,
     double *eta_ct)
   {
     double pt, pr0 = 0.0;
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_entropy_second_derivatives(
     double sa, double ct, double *eta_sa_sa,
   ...
   ***************************************************************************/
   double TeosBase::gsw_gibbs_ice(int nt, int np, double t, double p)
   {
     ...
     if (nt == 0 && np == 0) {
       ...
       sqtau_t2 = tau_t2 * tau_t2;
       g0p = gic.rec_pt *
         (gic.g01 + dzi * (2.0 * gic.g02 + dzi * (3.0 * gic.g03 + 4.0 * gic.g04 * dzi)));
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_linear_interp_sa_ct(
     double *sa, double *ct, double *p, int np,
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   double TeosBase::gsw_p_from_z(
     double z, double lat, double geo_strf_dyn_height,
     double sea_surface_geopotential)
   {
     ...
     df_dp = gtc.db2pa * gsw_specvol_sso_0(p);     
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_pot_enthalpy_ice_freezing_first_derivatives_poly(
     double sa, double p,
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_rho_alpha_beta(
     double sa, double ct, double p, double *rho,
   ...
   ***************************************************************************/
   ...
   double TeosBase::gsw_sp_from_c(double c, double t, double p)
   {
     ...
     rp = 1e0 + (p * (gspc.e1 + gspc.e2 * p + gspc.e3 * p * p)) /
       (1e0 + gspc.d1 * t68 + gspc.d2 * t68 * t68 +
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   double TeosBase::gsw_z_from_p(
     double p, double lat, double geo_strf_dyn_height,
     double sea_surface_geopotential)
   {
     double x, sin2, b, c, a;
   ...
   **************************************************************************/
   int TeosBase::gsw_linear_interp_sa_ct_for_dh(
     double *sa, double *ct, double *p,
   ...
   %==========================================================================
   ***************************************************************************/
   double TeosBase::gsw_specvol_anom(
     double SA, double CT, double p, double SA_ref,
     double CT_ref)
   {
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_specvol_second_derivatives_CT_exact(
     double SA,
     double CT,
     double p,
     double & v_SA_SA,
   ...
   ***************************************************************************/
   double TeosBase::gsw_beta_const_ct_t_exact(double SA, double t, double p)
   {
     ...
     g_SA_T_mod = 1187.3715515697959 + z * (1458.233059470092 +
       z *
       (-687.913805923122 + z * (249.375342232496 + z * (-63.313928772146 + 14.09317606630898 * z)))) +
       x *
       (-1480.222530425046 + x * (2175.341332000392 + x * (-980.14153344888 + 220.542973797483 * x) +
       y *
       (-548.4580073635929 + y *
       (592.4012338275047 + y * (-274.2361238716608 + 49.9394019139016 * y))) -
       90.6734234051316 * z) + z *
       (-525.876123559641 + (249.57717834054571 - 88.449193048287 * z) * z) +
       y *
       (-258.3988055868252 + z *
       (2298.348396014856 + z * (-325.1503575102672 + 153.8390924339484 * z)) +
       y *
       (-90.2046337756875 - 4142.8793862113125 * z + y *
       (10.50720794170734 + 2814.78225133626 * z)))) +
       y * (3520.125411988816 + y * (-1351.605895580406 +
       y * (731.4083582010072 + y * (-216.60324087531103 + 25.56203650166196 * y) +
       z * (-2381.829935897496 + (597.809129110048 - 291.8983352012704 * z) * z)) +
       z *
       (4165.4688847996085 + z *
       (-1229.337851789418 + (681.370187043564 - 66.7696405958478 * z) * z))) +
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_specvol_alpha_beta_CT_exact(
     double SA, double CT, double p,
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_rho_alpha_beta_indexed(
     double SA, double CT, double p,
     double & rho,
     double & alpha,
     double & beta)
   {
     ...
     z = p * gtc.rec_db2pa;
           ...
           /* gsvco */
     v = gsvco.v000 + xs *
       (gsvco.v100 + xs * (gsvco.v200 + xs * (gsvco.v300 + xs * (gsvco.v400 + xs * (gsvco.v500 +
       gsvco.v600 * xs))))) + ys *
       (gsvco.v010 + xs * (gsvco.v110 + xs * (gsvco.v210 + xs * (gsvco.v310 + xs * (gsvco.v410 +
       gsvco.v510 * xs)))) + ys *
       (gsvco.v020 + xs * (gsvco.v120 + xs * (gsvco.v220 + xs * (gsvco.v320 + gsvco.v420 * xs))) +
       ys *
       (gsvco.v030 + xs * (gsvco.v130 + xs * (gsvco.v230 + gsvco.v330 * xs)) + ys *
       (gsvco.v040 + xs * (gsvco.v140 +
       gsvco.v240 * xs) + ys * (gsvco.v050 + gsvco.v150 * xs + gsvco.v060 * ys))))) + z *
       (gsvco.v001 + xs * (gsvco.v101 +
       xs * (gsvco.v201 + xs * (gsvco.v301 + xs * (gsvco.v401 + gsvco.v501 * xs)))) + ys *
       (gsvco.v011 + xs * (gsvco.v111 +
       xs * (gsvco.v211 + xs * (gsvco.v311 + gsvco.v411 * xs))) + ys *
       (gsvco.v021 + xs * (gsvco.v121 + xs * (gsvco.v221 +
       gsvco.v321 * xs)) + ys *
       (gsvco.v031 + xs * (gsvco.v131 + gsvco.v231 * xs) + ys * (gsvco.v041 + gsvco.v141 * xs +
       gsvco.v051 * ys)))) + z *
       (gsvco.v002 + xs * (gsvco.v102 + xs * (gsvco.v202 + xs * (gsvco.v302 + gsvco.v402 * xs))) +
       ys *
       (gsvco.v012 + xs * (gsvco.v112 + xs * (gsvco.v212 + gsvco.v312 * xs)) + ys *
       (gsvco.v022 + xs * (gsvco.v122 +
       gsvco.v222 * xs) + ys * (gsvco.v032 + gsvco.v132 * xs + gsvco.v042 * ys))) + z *
       (gsvco.v003 + xs * (gsvco.v103 +
       gsvco.v203 * xs) + ys * (gsvco.v013 + gsvco.v113 * xs + gsvco.v023 * ys) + z *
       (gsvco.v004 + gsvco.v104 * xs +
       gsvco.v014 * ys + z * (gsvco.v005 + gsvco.v006 * z)))));
   
     rho = 1.0 / v;
   
     v_CT = gsvco.a000 + xs *
       (gsvco.a100 + xs * (gsvco.a200 + xs * (gsvco.a300 + xs * (gsvco.a400 + gsvco.a500 * xs)))) +
       ...
       xs * (gsvco.a130 + gsvco.a230 * xs) + ys *
       (gsvco.a040 + gsvco.a140 * xs + gsvco.a050 * ys )))) +
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_rho_first_derivatives_CT_exact(
     double SA, double CT, double p,
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_rho_first_derivatives_wrt_enthalpy_CT_exact(
     double SA,
     double CT,
     double p,
     double & rho_SA,
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_specvol_first_derivatives_CT_exact(
     double SA, double CT,
     double p,
     double & v_SA,
     double & v_CT,
   ...
   %==========================================================================
   ***************************************************************************/
   double TeosBase::gsw_specvol_anom_CT_exact(
     double SA, double CT, double p,
   ...
   ***************************************************************************/
   ...
   /*****************************************
      ...
      as a subfunction
   *****************************************/
   double TeosBase::gsw_specvol_from_pot_enthalpy_ice_first_derivatives_poly(
     double pot_enthalpy_ice,
     double p)
   {
     double v01 = -2.993503247981132e-10;
     double v02 = -2.187697844100046e-15;
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_specvol_first_derivatives_wrt_enthalpy_CT_exact(
     double SA,
     double CT,
     double p,
     double & v_SA,
   ...
   ***************************************************************************/
   ...
   % ==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_specvol_p_parts(
     double SA, double CT, double & vp0, double & vp1,
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_weighted_nanmean(
     double data, double weights,
   ...
   %==========================================================================
   ***************************************************************************/
   void TeosBase::gsw_rho_second_derivatives_CT_exact(
     double SA, double CT, double p,
     ...
     double *rho_CT_P)
   {
     ...
     gsw_specvol_second_derivatives_CT_exact(sa, CT, p, *v_SA_SA, *v_SA_CT, *v_CT_CT, *v_SA_P,
       *v_CT_P);
   ...
   %==========================================================================
   ***************************************************************************/
   double TeosBase::gsw_specvol_diff(
     double SA, double CT, double p_shallow,
     double p_deep)
   {
     double v011 = 1.8505765429e-5;
     double v012 = -1.1736386731e-6;
   ...
   ***************************************************************************/
   ...
   %==========================================================================
   ***************************************************************************/
   double TeosBase::gsw_enthalpy_diff_CT_exact(
     double SA, double CT,
     double p_shallow,
     double p_deep)
   {
   ...
   *************************************************************************/
   ...
   /***************************************************************************
      ...
      =======
   ****************************************************************************/
   void TeosBase::gsw_rr68_interp_section(
     int sectnum, double *sa, double *ct, double *p,
